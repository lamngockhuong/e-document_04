...
@section('page-header')
    @component('admin.layouts.page-header')
        @slot('page_title')
            @lang('admin.tag.create.page-header.page_title')
        @endslot
        @slot('page_description')
            @lang('admin.tag.create.page-header.page_description')
        @endslot
        @slot('breadcrumb')
            <li><a href="{{ route('admin.index') }}"><i class="fa fa-dashboard"></i> @lang('admin.dashboard.title')</a></li>
            <li>@lang('admin.tag.index.title')</li>
            <li class="active">@lang('admin.tag.create.title')</li>
        @endslot
    @endcomponent
@endsection
@section('content')
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin.tag.create.title')</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                {!! Form::open(['route' => 'tags.store', 'role' => 'form']) !!}
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        {!! Form::button(trans('admin.tag.create.form.submit'), ['class' => 'btn btn-success', 'type' => 'submit']) !!}
                    </div>
                {!! Form::close() !!}
            </div>
            <!-- /.box -->
